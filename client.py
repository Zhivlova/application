...
@log
def create_quit_message(account_name):
...
def user_help(sock, username):
    ...
    while True:
        ...
        if command == 'message':
            ...
            send_message(sock, create_quit_message(username))
...
def main():
    ...
    try:
        ...
        user_interface = threading.Thread(target=user_help, args=(transport, client_name))
